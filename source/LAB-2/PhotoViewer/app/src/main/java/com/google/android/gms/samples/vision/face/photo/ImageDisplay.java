...
public class ImageDisplay extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputStream streamMain = getResources().openRawResource(R.raw.sam);
        ...
        TextView eyetxt = (TextView) findViewById(R.id.textView7);
        eyetxt.setText("Eye probability: 1) Right Open: 0.9917 and 2) Left Open: 0.824" );

        TextView smile = (TextView) findViewById(R.id.textView4);
        smile.setText("Smile probability: 0.092" );
